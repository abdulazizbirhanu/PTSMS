...
{
    [Table("PERSONDOCUMENTAUDIT")]
    public class PersonDocumentAudit : AuditAttribute
    {
        [Key]
        ...
        [Index("UK_PersonDocumentAudit", IsUnique = true, Order = 1)]
        public int DocumentTypeId { get; set; }

        [ForeignKey("Person")]
        [Index("UK_PersonDocumentAudit", IsUnique = true, Order = 2)]
